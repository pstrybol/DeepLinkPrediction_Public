...
def plot_heatmap_performance_values(perf_d_1, perf_d_2=None, title=None, save_fp=None, save_raw_data=None,
                                    annotation=None, pdf=True, include_mean=False):
    ...
    if perf_d_2 is None:
        ...
        for i, perf_ in enumerate([perf_d_1, perf_d_2]):
            ...
            h = sns.heatmap(perf_df, cmap="RdYlBu", vmin=0, vmax=100, square=False,
                            linewidth=0.3, annot=True, ax=axs[i], annot_kws={"fontsize": 6})
            ...
            if annotation is not None:
                print(annotation[i])
                axs[i].annotate(annotation[i], xy=(-0.45, 1), xycoords='axes fraction', fontsize=8,
                                horizontalalignment='left', verticalalignment='top')
